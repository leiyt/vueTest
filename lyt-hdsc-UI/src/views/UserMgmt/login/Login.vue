        ...
        if (valid) {
          ...
          login(params).then(result => {
            ...
            if (result.data.token) {
              ...
              let scpUserStr = JSON.stringify(result.data)
              console.log('scpUserStr begin')
              console.log(scpUserStr)
              console.log('scpUserStr end')
              sessionStorage.setItem('scpUserInfo', scpUserStr)
