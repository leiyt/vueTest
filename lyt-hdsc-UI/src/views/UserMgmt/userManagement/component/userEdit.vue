<template>
  <div>
    ...
    <div v-show="gridUserGroup">
      <ass-user-group ref="associtedUserGroupVue" :userUuidValue="curUserUuidParm" :userTypeParm="curUserTypeParm"></ass-user-group>
    </div>
    <div v-show="gridUserRole">
      <ass-user-role ref="associtedUserRoleVue" :userUuidValue="curUserUuidParm" :userTypeParm="curUserTypeParm"></ass-user-role>
    </div>
  </div>
</template>
<script>
  ...
  methods: {
    handleSubTabClick (tab, event) {
      if (tab.name === '0') {
        ...
        this.listQueryUserEditVue.userUuid = this.curUserUuidParm
        this.curUserTypeParm = this.user.userType
