      ...
      <el-row class="margin-top-25">
        <el-col :span="24">
          <div class="text-right">
            ...
            <!--</div>-->
            <!--<div class="form-info">-->
              <!--<div class="item-info label">开始时间</div>-->
              <!--<div class="item-info">-->
                <!--&lt;!&ndash;<span class="demonstration">默认</span>&ndash;&gt;-->
                <!--<el-date-picker-->
                  <!--format="yyyy-MM-dd HH:mm"-->
                  <!--v-model="modelListSearch.createTime"-->
                  <!--type="datetime"-->
                  <!--placeholder="选择开始时间">-->
                <!--</el-date-picker>-->
                <!--&lt;!&ndash;<span v-if="isEndTimeErrorNoStart" class="red">请选择开始时间</span>&ndash;&gt;-->
                <!--&lt;!&ndash;<span v-if="isStartTimeError" class="red">开始时间不能早于当前时间</span>&ndash;&gt;-->
              <!--</div>-->
            <!--</div>-->
            <!--<div class="form-info">-->
              <!--<div class="item-info label">结束时间</div>-->
              <!--<div class="item-info">-->
                <!--&lt;!&ndash;<span class="demonstration">默认</span>&ndash;&gt;-->
                <!--<el-date-picker-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        // selectTimeSpan: [{
        //   value: this.getTimeSpan(-1),
        //   label: '最近24小时'
        // }, {
        //   value: this.getTimeSpan(-3),
        //   label: '最近72小时'
        // }, {
        //   value: this.getTimeSpan(-7),
        //   label: '最近7天'
        // }, {
        //   value: this.getTimeSpan(-30),
        //   label: '最近30天'
        // }, {
        //   value: this.getTimeSpan(-90),
        //   label: '最近90天'
        // }],
    ...
    methods: {
            ...
            function (result) {
              ...
              for (let i = 0; i < this.modelPlanList.length; i++) {
                if (this.modelPlanList[i].paramList.indexOf('{') > -1 && this.modelPlanList[i].paramList.indexOf('pl') > -1) {
                  ...
                  console.log(this.modelPlanList[i].paramListJson)
                }
      ...
      getTimeSpan (days) {
        ...
        // var d = this.dateAdd('d', days, curTimestamp)
        console.log('1231231:' + curTimestamp)
        console.log('gongke:' + (curTimestamp - days))
