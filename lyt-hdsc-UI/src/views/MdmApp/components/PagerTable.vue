<template>
  <div class="pager-table" v-loading="loading">
    <el-table height="100%" ref="table" :data="tableData" stripe border header-cell-class-name="text-align-center" @selection-change="onHandleSelectionChange" style="width: 100%;">
...
export default {
  ...
  methods: {
    ...
    /**
     * @description 请求用户参数
     * @param Object options 选择当前页的值、每页显示大小
     */
